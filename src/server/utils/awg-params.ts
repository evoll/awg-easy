...
const MTU = 1280;
const S1_MAX_MTU = MTU - MESSAGE_INITIATION_SIZE;
const S2_MAX_MTU = MTU - MESSAGE_RESPONSE_SIZE;
...
const MAGIC_HEADER_MAX = 0xffffffff;
...
export function validateAwgParams(
  params: Partial<AwgObfuscationParams>
): boolean {
