# Contributing to awg-easy

First and foremost, thank you! We appreciate that you want to contribute to awg-easy, your time is valuable, and your contributions mean a lot to us.
...
- **version**: (required) please note the version of awg-easy are you using
...
The original poster or the maintainers of awg-easy may close an issue at any time. Typically, but not exclusively, issues are closed when:
